...
def corre():
    ...
    select cast(ac.periodo as int) as periodo,   ac.valor as soja,  pr.valor as maiz,
        ...
        and c.alcance_tipo_id = ta.alcance_tipo_id
        and c.alcance_id = a.alcance_id
        and c.indicador_id=1 and c.sector_id=29 and c.variable_id=17 
        ...
        and c.alcance_tipo_id = ta.alcance_tipo_id
        and c.alcance_id = a.alcance_id
        and c.indicador_id=1 and c.sector_id=41 and c.variable_id=13 
        ...
        and c.alcance_tipo_id = ta.alcance_tipo_id
        and c.alcance_id = a.alcance_id
        and c.indicador_id=1  and c.sector_id=37 and c.variable_id=11
        ...
        and c.alcance_tipo_id = ta.alcance_tipo_id
        and c.alcance_id = a.alcance_id
        and c.indicador_id=1 and c.sector_id=29 and c.variable_id=4 
